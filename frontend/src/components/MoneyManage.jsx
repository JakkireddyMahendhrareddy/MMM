...
//         Amount: amount,
//         Type: type,
//         Date: new Date(createdAt).toLocaleDateString(), // Optional formatting
//       })
//     );
...
//   // Update form with transaction data when Edit button is clicked
...
//       // Update form fields with transaction data
...
//           `http://localhost:5001/api/transactions/${editId}`,
//           newTransaction
//         );

//         // Check response structure and update transactions accordingly
...
//           // Refetch all transactions to ensure sync with backend
...
//         } else {
//           // If response structure is unexpected, refetch all transactions
//           await fetchTransactions();
//         }
//       }
//     } catch (error) {
...
const MoneyManage = () => {
  ...
  const handleDeleteAll = async () => {
    ...
    try {
      ...
      await axios.delete("http://localhost:5001/api/transactions", config);
